...
const Add = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        formData.append("price", Number(data.price));  // Convert price to number if needed
        ...
        <div className='add'>
            <form onSubmit={onSubmitHandler}>
                ...
                <div className="add-category-price">
                    ...
                    <div className="price">
                        <p>Price</p>
                        <input onChange={onChangeHandler} value={data.price} type="text" name="price" placeholder='8' />
                    </div>
                </div>
